    ...
    function TabStrip(props) {
        ...
        _this.onKeyDown = function (event) {
            ...
            switch (event.keyCode) {
                ...
                case kendo_react_common_1.Keys.home:
                    handler = _this.keyBinding[kendo_react_common_1.Keys.home];
                    break;
                case kendo_react_common_1.Keys.end:
                    handler = _this.keyBinding[kendo_react_common_1.Keys.end];
                    break;
                default:
                    break;
            }
        ...
        _this.renderContent = function (tabProps) {
            ...
            if (selected < childrenCount && selected > -1) {
                return (React.createElement(TabStripContent_1.TabStripContent, __assign({ index: selected }, tabProps, { style: tabContentStyle })));
            }
            return null;
        };
