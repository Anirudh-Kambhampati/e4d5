...
.k-calendar-infinite .k-calendar-view::after {
    ...
    width: 150%;
    left: -25%;
    box-shadow: 0 0 36px 18px white;
}
...
.k-upload .k-file-error .k-file-extension-wrapper::before {
    background-color: white;
    border-color: transparent transparent rgba(0, 0, 0, 0.54) rgba(0, 0, 0, 0.54);
}
...
.k-fab-solid-primary:disabled {
    box-shadow: 0px 3px 5px -1px rgba(70, 70, 70, 0.232), 0px 6px 10px rgba(91, 91, 91, 0.1744), 0px 1px 18px rgba(101, 101, 101, 0.1552);
    border-color: #ececec;
...
.k-grid table td:focus,
.k-grid table td.k-focus,
.k-grid table th:focus,
.k-grid table th.k-focus,
...
.k-grid table tr:hover .k-grid-footer-sticky,
.k-grid table tr.k-hover .k-grid-header-sticky,
.k-grid table tr.k-hover .k-grid-footer-sticky {
    color: inherit;
    background-color: #ededed;
}

.k-grid table td:focus.k-grid-header-sticky, .k-grid table td:focus.k-grid-content-sticky, .k-grid table td:focus.k-grid-footer-sticky,
.k-grid table td.k-focus.k-grid-header-sticky,
.k-grid table td.k-focus.k-grid-content-sticky,
.k-grid table td.k-focus.k-grid-footer-sticky,
.k-grid table th.k-focus.k-grid-header-sticky,
.k-grid table th.k-focus.k-grid-content-sticky,
.k-grid table th.k-focus.k-grid-footer-sticky,
.k-grid table th:focus.k-grid-header-sticky,
.k-grid table th:focus.k-grid-content-sticky,
.k-grid table th:focus.k-grid-footer-sticky,
.k-grid table .k-master-row > td:focus.k-grid-header-sticky,
.k-grid table .k-master-row > td:focus.k-grid-content-sticky,
.k-grid table .k-master-row > td:focus.k-grid-footer-sticky,
.k-grid table .k-grouping-row > td:focus.k-grid-header-sticky,
.k-grid table .k-grouping-row > td:focus.k-grid-content-sticky,
.k-grid table .k-grouping-row > td:focus.k-grid-footer-sticky,
.k-grid table .k-detail-row > td:focus.k-grid-header-sticky,
.k-grid table .k-detail-row > td:focus.k-grid-content-sticky,
.k-grid table .k-detail-row > td:focus.k-grid-footer-sticky,
.k-grid table .k-group-footer > td:focus.k-grid-header-sticky,
.k-grid table .k-group-footer > td:focus.k-grid-content-sticky,
.k-grid table .k-group-footer > td:focus.k-grid-footer-sticky {
    color: inherit;
    background-color: #ededed;
}
...
.k-grid .k-grid-header-locked .k-header .k-group-footer.k-hover td,
...
.k-editor-inline.k-hover .k-editor-inline.k-active {
    border-color: rgba(0, 0, 0, 0.12);
}
...
.k-task-milestone.k-task-delayed {
    background-image: repeating-linear-gradient(90deg, white, white 2px, #f31700 2px, #f31700 4px);
}
...
.k-task-offset {
    background-image: repeating-linear-gradient(135deg, white, white 2px, #f31700 2px, #f31700 4px);
}
...
.k-task-offset:hover {
    background-image: repeating-linear-gradient(135deg, white, white 2px, #f87466 2px, #f87466 4px);
}
